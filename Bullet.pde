...
public class Bullet extends GameObject {
	...
	boolean isColliding(GameObject object) {
		...
		if (pos.y - objHeight / 2 > object.pos.y + object.objHeight / 2 ||
			pos.y + objHeight / 2 < object.pos.y - object.objHeight / 2)
			return false;
		// Check if wrong x -- LeftBullet > RightEnemy || RightBullet < LeftEnemy
		else if (pos.x - objWidth / 2 > object.pos.x + object.objWidth / 2 ||
			pos.x + objWidth / 2 < object.pos.x - object.objWidth / 2) {
			return false;
		}
		else {
